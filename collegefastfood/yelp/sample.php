...
$DEFAULT_TERM = 'fast food restaurants';
$DEFAULT_LOCATION = 'San Luis Obispo County, CA';
$SEARCH_LIMIT = 20;
$OFFSET_LIMIT = 0;
...
function displayBusinessInfo( $entry ){
    echo "<br>";
    echo utf8_decode ($entry->{'name'})."<br>";
    echo $entry->{'rating'}."<br>";
    echo $entry->{'url'}."<br>";
    echo $entry->{'location'}->{'city'}."<br>";
    echo $entry->{'location'}->{'postal_code'}."<br>";
    echo $entry->{'location'}->{'state_code'}."<br>";
    echo $entry->{'location'}->{'display_address'}[0]."<br>";
    echo $entry->{'location'}->{'display_address'}[1]."<br>";
    echo $entry->{'location'}->{'coordinate'}->{'latitude'}."<br>";
    echo $entry->{'location'}->{'coordinate'}->{'longitude'}."<br>";
